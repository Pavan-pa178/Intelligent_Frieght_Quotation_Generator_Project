...
|:---|:---|:---|:---|
| **Customs Officer** | `customs@portline.in` | `***REMOVED***` | `/customs` |
| **Freight Broker / Agent** | `agent@portline.in` | `***REMOVED***` | `/agent` |
| **Shipper (Customer)** | `demo@portline.in` | `***REMOVED***` | `/portal` |
| **Operations Admin** | `admin@portline.in` | `***REMOVED***` | `/admin` |
| **AI Agent Ops** | `agentop@portline.in` | `***REMOVED***` | `/agents` |
| **Analytics Manager** | `manager@portline.in` | `***REMOVED***` | `/analytics` |
