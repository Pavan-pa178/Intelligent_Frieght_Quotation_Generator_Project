...
import { ChevronLeft, Eye, EyeOff, User, Container, AlertTriangle, Shield, UserCheck } from 'lucide-react'
          ...
          {tab === 'signin' ? (
            <>
              ...
              <div className="my-5 flex items-center gap-3 text-[11px] uppercase tracking-wider text-brand-slateLight">
                <div className="h-px flex-1 bg-brand-line" /> or quick login <div className="h-px flex-1 bg-brand-line" />
              </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      setSiLoading(true)
                      try {
                        const userObj = await login({ email: 'agent@portline.in', password: '***REMOVED***' })
                        afterLogin(userObj)
                      } catch (err) {
                        setSiError(err.message)
                      } finally {
