          ...
          {tab === 'signin' ? (
            <>
              ...
              <div className="my-5 flex items-center gap-3 text-[11px] uppercase tracking-wider text-brand-slateLight">
                <div className="h-px flex-1 bg-brand-line" /> or <div className="h-px flex-1 bg-brand-line" />
              </div>

              <button
                type="button"
                onClick={handleDemo}
                className="flex w-full items-center justify-center gap-2 rounded-[10px] border-[1.5px] border-brand-line py-2.5 text-xs font-semibold text-brand-navy hover:bg-brand-cloud"
              >
                <User className="h-4 w-4" /> Try demo account
              </button>
            </>
          ) : (
            <>
