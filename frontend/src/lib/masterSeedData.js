 ...
 * Complete 19 Collections including Ocean, Standard Air, Express Air, Ground Trucking, and Rail Intermodal.
 */

export const MASTER_COLLECTIONS_META = [
  { key: 'ports', label: 'Ports & Terminals', icon: 'Ship', desc: '105 Global Sea Ports with UN/LOCODE, coordinates, max draft, and terminal operators' },
  { key: 'airports', label: 'Cargo Airports', icon: 'Plane', desc: '81 International Cargo Airports with IATA codes, runway length, and 24h customs info' },
  { key: 'trade_lanes', label: 'Trade Lanes', icon: 'Route', desc: '58 Multi-modal shipping lanes covering Ocean, Air, Express, Ground Road, and Rail Intermodal' },
  { key: 'carriers', label: 'Carriers & Lines', icon: 'Shield', desc: '49 Carriers: 20 Ocean Lines, 10 Airlines, 6 Express Integrators, 7 Ground Truckers & 6 Rail Freight Operators' },
  { key: 'service_types', label: 'Service Types', icon: 'Layers', desc: '12 Freight Modes: Ocean FCL/LCL, Air Gen/Express/Courier/Charter, Ground FTL/LTL & Rail Intermodal/Bulk' },
  { key: 'container_types', label: 'Container Types', icon: 'Box', desc: '15 Equipment specs: ISO 20/40/45, 53ft Domestic, 45ft Palletwide, 60ft Rail Flat, Mega Trailers & Air ULDs' },
  { key: 'rate_cards', label: 'Rate Cards', icon: 'DollarSign', desc: 'Active contract rate cards for Ocean FCL/LCL, Air, Express Next-Flight-Out, Rail, and Road FTL' },
  { key: 'surcharge_rules', label: 'Surcharge Rules', icon: 'Percent', desc: 'Dynamic surcharges: PSS, Red Sea War Risk, Congestion, Tolls, Lithium Batteries, Hazmat & Reefer' },
  ...
  { key: 'cargo_types', label: 'Cargo Types', icon: 'AlertTriangle', desc: 'General, Perishable, Pharma, and IMO Hazmat Classes 2, 3, 4, 6, 8, 9, Heavy Lift' },
  ...
  { key: 'incoterms', label: 'Incoterms 2020', icon: 'FileCheck', desc: 'All 11 ICC Incoterms rules with seller/buyer cost and risk responsibilities' },
  { key: 'charge_heads', label: 'Charge Heads', icon: 'CreditCard', desc: '33 Standardized freight, rail, trucking, customs, terminal, and administrative charge codes' },
  ...
  { key: 'currencies', label: 'Currencies', icon: 'Coins', desc: '12 Major trading currencies (USD, INR, EUR, AED, GBP, SGD, CNY, JPY, AUD, SAR, BRL, CAD)' },
  ...
  { key: 'packaging_types', label: 'Packaging Types', icon: 'Package', desc: 'Euro/GMA Pallets, Master Cartons, Wooden Crates, Drums, Flexitanks & Express Boxes' },
  { key: 'document_types', label: 'Document Types', icon: 'Files', desc: '15 Shipping documents: BL, AWB, COO, EUR.1, MSDS, Phytosanitary, Fastag, ISF' },
...
export function saveLocalMasterCollection(key, items) {
  try {
    localStorage.setItem(`portline_master_${key}`, JSON.stringify(items))
  } catch {}
}
